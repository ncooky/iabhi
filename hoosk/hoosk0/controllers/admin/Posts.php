...
class Posts extends CI_Controller {
	...
	public function confirm()
	{
		...
		$this->form_validation->set_rules('postURL', 'post URL', 'trim|alpha_dash|required|is_unique[post.postURL]');
	...
	public function edited()
	{
		...
		$this->load->library('form_validation');
		//Set validation rules
		$this->form_validation->set_rules('postURL', 'post URL', 'trim|alpha_dash|required|is_unique[post.postURL.postID.'.$this->uri->segment(4).']');
		$this->form_validation->set_rules('postTitle', 'post title', 'trim|required');
