...
<head>
<meta charset="utf-8">
<title>TLC CMS - <?php echo SITE_NAME; ?></title>
  ...
  <div class="subnavbar-inner">
    <div class="container">
      <ul class="mainnav">
        ...
        <li class="dropdown <?php if ($current == "partners") { echo "active"; } ?>"><a href="#" class="dropdown-toggle" data-toggle="dropdown"> <i class="icon-group"></i><span><?php echo $this->lang->line('nav_partners'); ?></span> <b class="caret"></b></a>
          <ul class="dropdown-menu">
            <li><a href="/admin/partners"><?php echo $this->lang->line('nav_partners_all'); ?></a></li>
            <li><a href="/admin/partners/new"><?php echo $this->lang->line('nav_partners_new'); ?></a></li>
          </ul>
        </li>        
