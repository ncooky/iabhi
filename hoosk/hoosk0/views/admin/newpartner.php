    ...
    <div class="container">
      ...
      <div class="span12">
          <div class="widget widget-nopad">
            ...
            <div class="content">
			<?php echo form_open(BASE_URL.'/admin/partners/new/add'); ?>

                <div class="control-group">		
                <?php echo form_error('partnerName', '<div class="alert">', '</div>'); ?>									
					<label class="control-label" for="username"><?php echo $this->lang->line('partner_new_name'); ?></label>
					<div class="controls">
                    <?php 	$data = array(
						  'name'        => 'partnerName',
						  'id'          => 'partnerName',
						  ...
						  'value'		=> set_value('partnerName', '', FALSE)
						);
                ...
                <?php echo form_error('partnerLink', '<div class="alert">', '</div>'); ?>									
					...
					<div class="controls">
						 <?php 	$data = array(
						  ...
						  'value'		=> set_value('partnerLink', '', FALSE)
						);
