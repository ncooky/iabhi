            ...
            <div class="widget-content">
    			...
    			echo form_open_multipart(BASE_URL.'/admin/settings/update'); ?>            
          		<div class="control-group">	
            		<?php echo form_error('siteAddress', '<div class="alert">', '</div>'); ?>									
					<label class="control-label" for="siteAddress"><?php echo $this->lang->line('settings_message'); ?></label>
					<div class="controls">
                    <?php 	$data = array(
						  'name'        => 'siteAddress',
						  'id'          => 'siteAddress',
                          ...
                          'cols'        => '5',
                          'style'       => 'max-width:95%',
						  'value'		=> set_value('siteAddress', $s['siteAddress'], FALSE)
						);
          		...
          		<div class="control-group">	
            		<?php echo form_error('sitePhone', '<div class="alert">', '</div>'); ?>									
    				<label class="control-label" for="sitePhone"><?php echo $this->lang->line('settings_phone'); ?></label>
    				<div class="controls">
                    <?php 	$data = array(
    					  'name'        => 'sitePhone',
    					  'id'          => 'sitePhone',
    					  'class'       => 'span4',
                          'style'       => 'max-width:95%',
    					  'value'		=> set_value('sitePhone', $s['sitePhone'], FALSE)
    					);
          		...
          		<div class="control-group">	
            		<?php echo form_error('siteFax', '<div class="alert">', '</div>'); ?>									
    				<label class="control-label" for="siteFax"><?php echo $this->lang->line('settings_fax'); ?></label>
    				<div class="controls">
                    <?php 	$data = array(
    					  'name'        => 'siteFax',
    					  'id'          => 'siteFax',
    					  'class'       => 'span4',
                          'style'       => 'max-width:95%',
    					  'value'		=> set_value('siteFax', $s['siteFax'], FALSE)
    					);
          		...
          		<div class="control-group">	
            		<?php echo form_error('siteEmail', '<div class="alert">', '</div>'); ?>									
            ...
            <div class="control-group">
					...
					<?php
						...
						foreach ($themesdir as $t){
							if (!is_dir($t)){
								if (($t != "index.html") && (substr($t,0, strrpos($t, '/')) != "admin")){
									$data[substr($t,0, strrpos($t, '/'))] = substr($t,0, strrpos($t, '/'));
								}
							}
						}
                ...
                <div class="control-group">
					...
					<?php
						...
						foreach ($langdir as $l){
							if (!is_dir($l)){
								if ($l != "index.html"){
									$data[substr($l,0, strrpos($l, '/'))] = stripslashes(str_replace("/", "", $l));	
								}
							}
						}
