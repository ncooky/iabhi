<?php
  ...
  if ((isset($_POST["accion"])) && ($_POST["accion"] == "insert")) {
	...
	if ($data['name'] == '') { 
	//The group esta mal
      $Session["groups"]["message"].=', ' . $lang['cpanel']['groups']['groupname_wrong']; 	
      $no = 1;
    }

    if (!$no) { //Si todo esta bien se inserta el group
	  $insertSQL = sprintf("INSERT INTO %sgroups (creation_date, update_date, group1, group2, group3, name) VALUES (NOW(), NOW(), %s, %s, %s, %s);",
                           $tables_preffix,
...
<html>
<head>
<title><?php echo $lang['all']['bfexplorer']; ?> - <?php echo $lang['all']['control_panel']; ?> - <?php echo $lang['cpanel']['groups']['new_group']; ?></title>
...
<div align="center"> 
  <table width="700" border="0" cellspacing="0" cellpadding="2"> 
    <tr height="30"> 
      ...
      <th width="99%" align="left" valign="middle" background="../../images/borders/topBorder.jpg"><?php echo $lang['all']['bfexplorer']; ?> - <?php echo $lang['all']['control_panel']; ?> - <?php echo $lang['cpanel']['groups']['new_group']; ?></th> 
      <th width="4" background="../../images/borders/right_topCorner.jpg"></th> 
    </tr> 
    <tr> 
      <td background="../../images/borders/leftBorder.jpg"></td> 
      <td align="left" valign="top"><form action="new.php" method="POST" name="insert" id="insert" onSubmit="YY_checkform('insert','data[name]','#q','0','<?php echo $lang['cpanel']['groups']['groupname_wrong']; ?>');return document.MM_returnValue"> 
          <table width="100%" border="0" cellspacing="3" cellpadding="5" align="center"> 
            ...
            <tr bgcolor="#FFFFFF"> 
              <td width="29%" align="right">*<?php echo $lang['cpanel']['groups']['name']; ?>:</td> 
