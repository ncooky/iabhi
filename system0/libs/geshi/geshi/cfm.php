...
$language_data = array (
	...
	'KEYWORDS' => array(
		...
		5 => array(
			...
			'DateCompare','IsXmlTheem','StructCount','DateConvert','IsXmlNode','StructDelete','DateDiff','IsXmlRoot','StructFind',
			...
			'Fix','Log10','XmlChildPos','FormatBaseN','LSCurrencyFormat','XmlTheemNew','GetAuthUser','LSDateFormat','XmlFormat',
