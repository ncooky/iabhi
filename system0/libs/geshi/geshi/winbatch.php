...
$language_data = array (
	...
	'KEYWORDS' => array(
		1 => array(
			...
			'EndSelect', 'EndIf', '#EEndFunction', 'EndFor', 'End', 'These', 'DropWild', 'Drop', '#DefineSubRoutine', 
		...
		4 => array(
			...
			'zLPortShift', 'zGetPortBit', 'zClrPortBit', 'xVerifyCCard', 'xSendMessage', 'xMessageBox', 'xMemCompact', 'xHex', 'xGetTheapsed', 
